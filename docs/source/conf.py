...
project = u'Molecule'
copyright = u'2015, Adam Brown, John Dewey, Rémy Greinhofer'
author = u'Adam Brown, John Dewey, Rémy Greinhofer'
...
latex_documents = [
  (master_doc, 'Molecule.tex', u'Molecule Documentation',
   u'Adam Brown, John Dewey, Rémy Greinhofer', 'manual'),
]
...
texinfo_documents = [
  (master_doc, 'Molecule', u'Molecule Documentation',
   author, 'Molecule', 'One line description of project.',
   'Miscellaneous'),
]
